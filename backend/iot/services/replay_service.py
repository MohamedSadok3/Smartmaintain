...
class ReplayService:
    ...
    def publish_machine_window(self, machine: str, window: List[Dict], skip_normalization: bool = False) -> Optional[Dict]:
        """
        ...
        Args:
            ...
            skip_normalization: If True, don't apply normal bias (for manual injections)
        ...
        try:
            ...
            # Check if we should normalize this batch (skip if manual injection)
            normalize = self._should_normalize() and not skip_normalization
